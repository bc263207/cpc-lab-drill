...
Arm B (disposition scenarios) waits on the patient model. Moodle XML export is deferred; the item format resolves reference range and source from the table at export time.
